...
def describing_rules_again():
    ...
    rules = [
        ...
        "why one must NOT eat single-grain bread",
        "why one must NOT drink single-grain alcohol",
        "one should never eat single-grain bread",
        "one should never drink single-grain alcohol",
